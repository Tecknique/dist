...
\newcommand{\coursepath}{/teaching/2122/ConcDisSys}
...
\newcommand{\networking}{https://www.cl.cam.ac.uk/teaching/2122/CompNet/}
\newcommand{\security}{https://www.cl.cam.ac.uk/teaching/2122/Security/}
\newcommand{\ledgersystems}{https://www.cl.cam.ac.uk/teaching/2122/R47/}
\newcommand{\multicore}{https://www.cl.cam.ac.uk/teaching/2122/L304/}
...
% TODO: have title slide with my name, course title, university crest for each video?
...
\end{frame}
\inlineslide{s:dist-sys-definition}{\href{https://www.youtube.com/watch?v=UEAMfLPZZhE&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=1}{Start of video section 1.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/09.1_Distributed_systems_introduction.mp4}{mp4 download})}\label{l:dist-sys-definition}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:networking}{\href{https://www.youtube.com/watch?v=1F3DEq8ML1U&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=2}{Start of video section 1.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/09.2_Computer_networking.mp4}{mp4 download})}
...
\begin{frame}
    ...
    \end{center}
\end{frame}
\inlineslide{s:payment-example}{\href{https://www.youtube.com/watch?v=S2osKiqQG9s&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=3}{Start of video section 1.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/09.3_Remote_Procedure_Call.mp4}{mp4 download})}
...
\supervision{
    ...
    \begin{itemize}
        ...
        \item RPC clients and servers may need to take measures to make function invocation \emph{idempotent} (this concept is introduced in Lecture 5), to allow safe retries in case of message loss.
...
\begin{frame}
    ...
    \end{center}
\end{frame}
\inlineslide{s:two-generals}{\href{https://www.youtube.com/watch?v=MDuWnzVnfpI&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=4}{Start of video section 2.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/10.1_Two_generals_problem.mp4}{mp4 download})}\label{l:two-generals}
...
If a general does not receive any messages, it is impossible to tell whether this is because the other general didn't send any messages, or because all messengers were captured.\footnote{I am not a fan of this militaristic analogy, but we will stick with ``two generals'' since the problem is well-known under that name.
...
\begin{frame}
    ...
    \end{center}
\end{frame}
\inlineslide{s:byzantine-generals}{\href{https://www.youtube.com/watch?v=LoGx_ldRBU0&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=5}{Start of video section 2.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/10.2_Byzantine_generals_problem.mp4}{mp4 download})}\label{l:byzantine-generals}
...
We will not go into details of digital signatures in this course, as they are covered in the \href{\security}{Security} course (\whenissecurity).
...
\end{frame}
\inlineslide{s:system-model}{\href{https://www.youtube.com/watch?v=y8f7ZG_UnGI&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=6}{Start of video section 2.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/10.3_System_models.mp4}{mp4 download})}\label{l:system-model}
...
\supervision{
    ...
    This approach has the effect of making the RPC \emph{idempotent}, which we will discuss further in Lecture 5.
}
...
The \emph{Transport Layer Security} (TLS) protocol, which provides the ``s'' for ``secure'' in \verb|https://|, prevents an active adversary from eavesdropping, modifying, spoofing, or replaying traffic (more on this in the \href{\security}{Security} course, \whenissecurity).
...
\end{frame}
\inlineslide{s:availability}{\href{https://www.youtube.com/watch?v=43TDfUNsM3E&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=7}{Start of video section 2.4}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/10.4_Fault_tolerance.mp4}{mp4 download})}\label{l:availability}
...
\begin{frame}
    ...
    (up to some maximum number of faults)\\[1em]
...
Being able to roll out software upgrades in this way, without clients noticing any interruption, is important for many organisations that are continually working to improve their software.
...
\begin{frame}
    ...
    What happened?
\end{frame}
\inlineslide{s:mystery}{\href{https://www.youtube.com/watch?v=FQ_2N3AQu0M&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=8}{Start of video section 3.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/11.1_Physical_time.mp4}{mp4 download})}\label{l:mystery}
...
\end{frame}
\inlineslide{s:clock-sync}{\href{https://www.youtube.com/watch?v=mAyW-4LeXZo&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=9}{Start of video section 3.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/11.2_Clock_synchronisation.mp4}{mp4 download})}\label{l:clock-sync}
...
\end{frame}
\inlineslide{s:moon-cheese}{\href{https://www.youtube.com/watch?v=OKHIdpOAxto&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=10}{Start of video section 3.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/11.3_Causality_and_happens-before.mp4}{mp4 download})}\label{l:moon-cheese}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:logical-clocks}{\href{https://www.youtube.com/watch?v=x-D8iFU1d-o&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=11}{Start of video section 4.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/12.1_Logical_time.mp4}{mp4 download})}\label{l:logical-clocks}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:broadcast-intro}{\href{https://www.youtube.com/watch?v=A8oamrHf_cQ&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=12}{Start of video section 4.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/12.2_Broadcast_delivery_order.mp4}{mp4 download})}\label{l:broadcast-intro}
...
\begin{frame}
    ...
    \end{center}%
\end{frame}
\inlineslide{s:broadcast-alg}{\href{https://www.youtube.com/watch?v=77qpCahU3fo&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=13}{Start of video section 4.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/12.3_Broadcast_algorithms.mp4}{mp4 download})}\label{l:broadcast-alg}
...
\supervision{
    ...
    Further assume that the underlying network provides reliable FIFO broadcast. [\href{https://www.cl.cam.ac.uk/teaching/exams/pastpapers/y2020p5q8.pdf}{2020 Paper 5 Question 8}]
}{
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:replication-intro}{\href{https://www.youtube.com/watch?v=mBUCF1WGI_I&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=14}{Start of video section 5.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/13.1_Replication.mp4}{mp4 download})}\label{l:replication-intro}
...
Unavailability could be due to a faulty node (e.g.\ a crash or a hardware failure), due to a network partition (inability to reach a node over the network), or planned maintenance (e.g.\ rebooting a node to install software updates, as discussed in \autoref{sec:fault-tolerance}).
...
\begin{frame}
    ...
    \end{tabular}
\end{frame}
\inlineslide{s:fault-probability}{\href{https://www.youtube.com/watch?v=uNxl3BFcKSA&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=15}{Start of video section 5.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/13.2_Quorums.mp4}{mp4 download})}\label{l:fault-probability}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:smr}{\href{https://www.youtube.com/watch?v=mlWOQuO55PE&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=16}{Start of video section 5.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/13.3_State_machine_replication.mp4}{mp4 download})}\label{l:smr}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:failover}{\href{https://www.youtube.com/watch?v=rN6ma561tak&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=17}{Start of video section 6.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/14.1_Consensus.mp4}{mp4 download})}\label{l:failover}
...
% TODO: introduce the concept of safety and liveness properties explicitly?
...
\begin{frame}
    ...
    \end{center}%
\end{frame}
\inlineslide{s:raft-states}{\href{https://www.youtube.com/watch?v=uXEYuDwm7e4&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=18}{Start of video section 6.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/14.2_Raft.mp4}{mp4 download})}\label{l:raft-states}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:consistency}{\href{https://www.youtube.com/watch?v=-_rdWB9hN1c&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=19}{Start of video section 7.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/15.1_Two-phase_commit.mp4}{mp4 download})}\label{l:consistency}
...
\end{frame}
\inlineslide{s:linearizability}{\href{https://www.youtube.com/watch?v=noUNH3jDLC0&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=20}{Start of video section 7.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/15.2_Linearizability.mp4}{mp4 download})}\label{l:linearizability}
...
\end{frame}
\inlineslide{s:eventual-1}{\href{https://www.youtube.com/watch?v=9uCP3qHNbWw&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=21}{Start of video section 7.3}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/15.3_Eventual_consistency.mp4}{mp4 download})}\label{l:eventual-1}
...
\begin{frame}
    \begin{center}
        Lecture 8\\[2em]
        \Large{\color{darkblue}{Case studies}}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:collaboration}{\href{https://www.youtube.com/watch?v=OqqliwwG0SM&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=22}{Start of video section 8.1}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/16.1_Collaboration.mp4}{mp4 download})}\label{l:collaboration}
...
Despite having ``strong'' in the name, strong eventual consistency is a fairly weak consistency property: for example, when reading a value, there is no guarantee that the operation will return the most up-to-date value, because it may take some time for updates to propagate from one replica to another.
...
\end{frame}
\inlineslide{s:spanner-intro}{\href{https://www.youtube.com/watch?v=oeycOVX70aE&list=PLeKd45zvjcDFUEv_ohr_HdUFe97RItdiB&index=23}{Start of video section 8.2}\\(\href{https://www.cl.cam.ac.uk/teaching/2122/ConcDisSys/video/16.2_Spanner.mp4}{mp4 download})}\label{l:spanner-intro}

Many of the techniques used by Spanner are very conventional, and we have seen them earlier in this course: it uses the Paxos consensus algorithm for state machine replication, two-phase locking to ensure serializable isolation between transactions, and two-phase commit to ensure atomic commitment.
...
\begin{frame}
    ...
    \end{itemize}
\end{frame}
\inlineslide{s:snapshots}{}\label{l:snapshots}
...
In order to ensure that snapshots are consistent with causality, the MVCC algorithm requires that if transaction $T_1$ happened before transaction $T_2$, then the commit timestamp of $T_1$ must be less than that of $T_2$.
...
\begin{frame}
    ...
    \begin{center}
        \begin{tikzpicture}
            \node [rectangle,fill=red!10,draw] (node1) at (0,4.5) {\storageSymbol}; \node [yshift=-0.2cm] at (node1) {$A$};
            \node [alice,minimum size=1cm]     (node2) at (4,4.5) {};
            \node [rectangle,fill=red!10,draw] (node3) at (8,4.5) {\storageSymbol}; \node [yshift=-0.2cm] at (node3) {$B$};
            \draw (node1) -- (0,0.3);
            \draw (node2) -- (4,0.3);
            \draw (node3) -- (8,0.3);
            \node<4-> [rectangle,fill=white,draw,text depth=0.3cm] (T1) at (0,3) {$T_1$};
            \node<5-> [rectangle,fill=white,draw,text depth=0.3cm] (T2) at (8,1) {$T_2$};
            \draw<4-> [bigarrow] (T1.south east) -- node [above,sloped] {results} (4,2.1);
            \draw<5-> [bigarrow] (4,1.9) -- node [above,sloped] {action} (T2.north west);
        \end{tikzpicture}
    \end{center}%
\end{frame}
\inlineslide{s:commit-timestamps}{}\label{l:commit-timestamps}
...
When you ask TrueTime for the current timestamp, it returns an interval $[t_\mathsf{earliest}, t_\mathsf{latest}]$.
The system does not know the true current physical timestamp $t_\mathsf{real}$, but it can ensure that $t_\mathsf{earliest} \le t_\mathsf{real} \le t_\mathsf{latest}$ with very high probability by taking all of the above sources of error into account.

\begin{frame}
    \label{s:truetime}
    \frametitle{TrueTime: explicit physical clock uncertainty}
    \uncover<2->{Spanner's TrueTime clock returns $[t_\mathsf{earliest}, t_\mathsf{latest}]$.}\\%
    \uncover<2->{True physical timestamp must lie within that range.}\\%
    \uncover<3->{On commit, wait for uncertainty $\delta_i = t_{i,\mathsf{latest}} - t_{i,\mathsf{earliest}}$.}\\[0.5em]
    \begin{tikzpicture}
        \node [rectangle,fill=red!10,draw] (node1) at (1,4.5) {\storageSymbol}; \node [yshift=-0.2cm] at (node1) {$A$};
        \node [text width=1.5cm,align=center] (node2) at (4,4.5) {physical time};
        \node [rectangle,fill=red!10,draw] (node3) at (7,4.5) {\storageSymbol}; \node [yshift=-0.2cm] at (node3) {$B$};
        \draw (node1) -- (1,-1.2);
        \draw (node3) -- (7,-1.2);
        \useasboundingbox (-1,0);
        \tikzstyle{wait}=[rectangle,fill=blue!10,draw,anchor=west,rotate=270,font=\footnotesize,minimum height=0.7cm,minimum width=1cm]
        \node<1-> [rectangle,fill=white,draw,text depth=0.3cm,minimum width=0.7cm] (T1) at (1,3.0) {$T_1$};
        \node<4-> [rectangle,fill=white,draw,text depth=0.3cm,minimum width=0.7cm] (T2) at (7,0.5) {$T_2$};
        \node<3-> [wait] (wait1) at (T1.south) {wait};
        \node<5-> [wait] (wait2) at (T2.south) {wait};
        \draw<2-> [line width=3pt] (T1.south west) -- node [at start,left,font=\scriptsize] {commit req} (T1.south east);
        \draw<4-> [line width=3pt] (T2.south west) -- node [at end,right,font=\scriptsize] {commit req} (T2.south east);
        \draw<3-> [line width=3pt] (wait1.south east) -- node [at start,left,font=\scriptsize] {commit done} (wait1.north east);
        \draw<5-> [line width=3pt] (wait2.south east) -- node [at end,right,font=\scriptsize] {commit done} (wait2.north east);
        \fill<2-> [blue!10] (T1.south east) -- (4,3.0) -- (4,2.0) -- cycle;
        \fill<4-> [blue!10] (T2.south west) -- (4,0.5) -- (4,-0.5) -- cycle;
        \draw<2-> [blue] (3.8,3.0) -- node [at start,above left,inner sep=0pt] {$t_{1,\mathsf{earliest}}$} (4.4,3.0);
        \draw<2-> [blue] (3.8,2.0) -- node [at start,below left,inner sep=0pt] {$t_{1,\mathsf{latest}}$} (4.4,2.0);
        \draw<4-> [blue] (3.6,0.5) -- node [at end,above right,inner sep=0pt] {$t_{2,\mathsf{earliest}}$} (4.2,0.5);
        \draw<4-> [blue] (3.6,-0.5) -- node [at end,below right,inner sep=0pt] {$t_{2,\mathsf{latest}}$} (4.2,-0.5);
        \draw<3-> [blue,<->] (4.2,3.0) -- node [right] {$\delta_1$} (4.2,2.0);
        \draw<5-> [blue,<->] (3.8,0.5) -- node [left] {$\delta_2$} (3.8,-0.5);
        \node<3-> [right=0.2cm of wait1.north west,inner sep=0] (wait1a) {};
        \node<3-> [right=0.2cm of wait1.north east,inner sep=0] (wait1b) {};
        \draw<3-> [blue,<->] (wait1a) -- node [right] {$\delta_1$} (wait1b);
        \node<5-> [left=0.2cm of wait2.south west,inner sep=0] (wait2a) {};
        \node<5-> [left=0.2cm of wait2.south east,inner sep=0] (wait2b) {};
        \draw<5-> [blue,<->] (wait2a) -- node [left] {$\delta_2$} (wait2b);
        \draw<1-> (node2) -- (4,-0.8);
        \draw<6-> (wait1.north east) edge [-{Stealth},red,thick,densely dashed] node [above,red,font=\scriptsize] {real time} (T2.north west);
    \end{tikzpicture}
\end{frame}
\inlineslide{s:truetime}{}\label{l:truetime}
...
Google achieves this by installing atomic clocks and GPS receivers in every datacenter, and synchronising every node's quartz clock with a time server in the local datacenter every 30~seconds.
In the local datacenter, round-trips are usually below 1~ms, so the clock error introduced by network latency is quite small.
If the network latency increases, e.g.\ due to congestion, TrueTime's uncertainty interval grows accordingly to account for the increased error.

\begin{frame}
    \label{s:truetime-sync}
    \frametitle{Determining clock uncertainty in TrueTime}
    Clock servers with \textbf{atomic clock} or \textbf{GPS receiver} in each datacenter;
    servers report their clock uncertainty.\\%
    \uncover<2->{Each node syncs its quartz clock with a server every 30 sec.}\\%
    \uncover<3->{Between syncs, assume worst-case drift of 200ppm.}\\[1em]%
    \begin{tikzpicture}
        \draw [-{Classical TikZ Rightarrow[length=2mm]}] (0,0) -- node [at end,right,inner xsep=10pt] {local clock uncertainty [ms]} (0,4);
        \draw [-{Classical TikZ Rightarrow[length=2mm]}] (0,0) -- node [at end,above left,inner xsep=0pt,inner ysep=10pt] {time [s]} (10,0);
        \foreach \y / \label in {0/0, 1/2, 2/4, 3/6} \draw (-0.1,\y) -- node [at start,left] {$\label$} (0.1,\y);
        \foreach \x / \label in {0/0, 1/10, 2/20, 3/30, 4/40, 5/50, 6/60, 7/70, 8/80, 9/90} \draw (\x,-0.1) -- node [at start,below] {$\label$} (\x,0.1);
        \draw<3-> [blue,thick] (0.0,2.0) -- (1.5,3.5) -- (1.5,0.5) -- (4.5,3.5) -- (4.5,0.5) -- (7.5,3.5) -- (7.5,0.5) -- (9.0,2.0);
        \draw<2-> [->,red,thick] (1.5,-1) -- node [at start,below right,inner xsep=0] {sync with clock server} (1.5,-0.1);
        \draw<2-> [->,red,thick] (4.5,-1) -- (4.5,-0.1);
        \draw<2-> [->,red,thick] (7.5,-1) -- (7.5,-0.1);
        \draw<4-> [darkgreen,dashed] (0.0,0.5) -- (8.5,0.5);
        \draw<4-> [<->,darkgreen,thick] (0.5,0) -- node [right,font=\footnotesize] {server uncertainty + round trip time to clock server} (0.5,0.5);
        \useasboundingbox (0,-1.7);
    \end{tikzpicture}
\end{frame}
\inlineslide{s:truetime-sync}{}\label{l:truetime-sync}

In between the periodic clock synchronisations every 30~seconds, a node's clock is determined only by its local quartz oscillator.
